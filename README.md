...
**The Sun Standard** is a research project exploring how Bitcoin mining can integrate with renewable energy systems—particularly solar—to support a more efficient and circular energy economy.
...
### 🧠 Research Papers
- `sun_standard.pdf` — Main research paper (EN)
- `sun_standard_fr.pdf` — French version
- `Circular_Economy_for_Bitcoin_ASICs.pdf` — ASIC lifecycle & reuse
- `Economie_circulaire_du_Minage_Bitcoin.pdf` — French version

### 🖼️ Visuals
- `SunStandardMethodology.png` — Core methodology diagram
- `BitcoinMiningResearch.jpg` — Concept illustration

### 🌐 Website
- `index.html` — Simple static page presenting the project
...
- Explore the methodology visually:  
  👉 `SunStandardMethodology.png`
